proc do_compile {} {
  ...
  vlog -work work -coverall "../src/*.sv" 
	vlog -work work -coverall "globals.vh" 	
	vlog -work work -coverall "*.sv" 

}

proc start_sim {} {
  # insert name of testbench module
	vsim -coverage -novopt -L lpm_ver -L sgate_ver -L altera_mf_ver tb_top 
